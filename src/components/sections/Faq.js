      ...
      <Container>
        <Box>
          ...
          <Accordion title="WHY DO WE NEED ROYALTIES?">
            The amount of royalties was fixed at 5% to finance the Alpha Legion
        ...
        <Box>
          ...
          <Accordion title="WHAT ARE THE ALPHA LEGION?">
            We have the ambition to organize multiple events around the world in
            order to strengthen the community and build a network of
            entrepreneurs and investors with the same mindset and common
            interests.
          </Accordion>
          <Accordion title="WHAT IS THE FUSION PROCESS?">
            In futurism and science fiction, it is often described as a
